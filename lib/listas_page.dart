...
class _ListasPageState extends State<ListasPage>{
          ...
          children: <Widget>[
            ...
            new MergeSemantics(
              child: ListTile(
                ...
                trailing: Checkbox(value: _showAvatars, onChanged: (bool value){
                    setState((){
                      _showAvatars = value;
                    });
                    _bottomSheet?.setState((){});
            ...
            new MergeSemantics(
              child: ListTile(
                  ...
                  trailing: Checkbox(value: _showIcons, onChanged: (bool value){
                    setState((){
                      _showIcons = value;
                    });
                    _bottomSheet?.setState((){});
  ...
  Widget buildListTile(BuildContext context, String item){
    ...
    if(_itemType == _MaterialListType.duasLinhas){
      ...
      secondary = const Text('Essa linha adicional aparece com o modelo 3 linhas. Vou adicionar mais texto aqui para quebrar a terceira a linha..');
    }
